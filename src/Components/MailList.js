...
const MailList = (props) => {
    ...
    const readMessageHandler = () => {
        if (inbox) {
            ...
            axios
                .put(
                    `https://chat-box-3816d-default-rtdb.firebaseio.com/mails/${userId}inbox/${props.id}.json`,
                    mailDetails
                )
            ...
            axios
                .put(
                    `https://chat-box-3816d-default-rtdb.firebaseio.com/mails/${userId}sentbox/${props.id}.json`,
                    mailDetails
                )
